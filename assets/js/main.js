...
(function($) {
    ...
    var preloader = function() {
        ...
        if (pageLoader.length) {
            ...
            bodySelector.delay(3000).removeClass('preloader-active');
        }
    };
...
preloaderImage.src = "https://assets9.lottiefiles.com/packages/lf20_vIqsDp.json";
preloaderImage.onload = function() {
    // Resim tam olarak yüklendiğinde yapılacak işlemler
    // Örneğin preloader'ı gizleyebilirsiniz.
}
...
function scrollFunction() {
    if (document.body.scrollTop > 20 || document.documentElement.scrollTop > 20) {
        ...
        myNavbar.style.boxShadow='5px 5px 10px rgba(0, 0, 0, 0.5)';
